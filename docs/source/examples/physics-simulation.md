...
:::{admonition} Automatically parse Numpy, Google, and Sphinx style docstrings",
:class: note, dropdown

This feature uses the [Rich](https://rich.readthedocs.io/en/stable/introduction.html) and [Griffe](https://mkdocstrings.github.io/griffe/) library to parse doc-strings and print documentation.
Make sure to install it using `pip install "pipefunc[autodoc]"`
:::

```{code-cell} ipython3
pipeline_charge.print_doc()
```
