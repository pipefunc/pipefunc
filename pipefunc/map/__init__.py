...
from ._load import load_all_outputs, load_dataframe, load_outputs, load_xarray_dataset
...
with _suppress(ImportError):
    ...
    warnings.filterwarnings("ignore", message=".*google-crc32c.*", category=RuntimeWarning)
